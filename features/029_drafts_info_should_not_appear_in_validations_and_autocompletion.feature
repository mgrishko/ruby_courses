...
Feature: Supplier shouldn't see data from drafts in validations or autocompletion
  ...
  Background:
    ...
    And the following base_items exist
      |item_id|user_id|gtin|brand|subbrand|functional|variant|item_description|manufacturer_name| manufacturer_gln|status|
      |1|1|11234567|Coca-cola|explorer|juice|lemon|coca-cola juise lemon|Coca-cola Ltd.| 12345679|published|
      |2|1|7654321|Wrangler|frontier|jeans|blue|wrangler jeans blue|Wrangler Inc.|97654321|draft|
