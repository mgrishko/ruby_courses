...
Feature:  Supplier can reply 
  ...
  Scenario: Retailer add Retailer Attributes
    ...
    Then I should see "ret-attr-2" within "#retailer_attributes"
    Then I should see "ret-attr-3" within "#retailer_attributes"
    Then I should see "ret-attr-4" within "#retailer_attributes"
    ...
    Then I should not see "ret-attr-2" within "#retailer_attributes"
    Then I should not see "ret-attr-3" within "#retailer_attributes"
    Then I should not see "ret-attr-4" within "#retailer_attributes"
    ...
    Then I should see "ret-attr-12" within "#retailer_attributes"
    Then I should see "ret-attr-13" within "#retailer_attributes"
    Then I should see "ret-attr-14" within "#retailer_attributes"
