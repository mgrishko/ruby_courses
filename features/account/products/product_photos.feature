Feature: Product photos
  ...
  Scenario: Editor successfully adds new product photo
    ...
    And he selects the product photo
    Then he should see "Uploading"
    Then he should see "Photo was successfully uploaded"
  ...
  Scenario: Editor can delete product photo
    ...
    And an authenticated user with editor role
    And he is on the product page
    When he follows "Delete photo"
    Then he should see "Photo was successfully deleted"
