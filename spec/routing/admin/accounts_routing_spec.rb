...
describe Admin::AccountsController do
  describe "routing" do
    ...
    it "routes to #index" do
      get("http://app.example.com/dashboard/accounts").should route_to("admin/accounts#index", subdomain: "app")
    end

    it "routes to #show" do
      get("http://app.example.com/dashboard/accounts/1").should route_to("admin/accounts#show", id: "1", subdomain: "app")
    end

    it "routes #new to #show (#new should not be routable)" do
      get("http://app.example.com/dashboard/accounts/new").should route_to("admin/accounts#show", id: "new", subdomain: "app")
    end
