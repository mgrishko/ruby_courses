...
Rails::Initializer.run do |config|
  ...
  config.action_controller.session = {
    ...
    :secret      => '90a335d6950bafe9a02a20c460a7ab35478165f7e7b8743bab9f8906a91edb83db53eeaa07f9a0a68097fb6360bcfa33644d932035c898683981ed3a147b9036'
  }
...
Time::DATE_FORMATS.merge!({:short => "%Y-%m-%d", :cmnt => "%a, %d %b %Y, %H:%M"})
